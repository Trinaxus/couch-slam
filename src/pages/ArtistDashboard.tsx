        ...
        <div className="space-y-6">
          {!artist ? (
            ...
            <form onSubmit={handleSubmitApplication} className="bg-gray-800 rounded-lg p-6 border border-gray-700 space-y-4">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold py-2 px-6 rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all flex items-center gap-2"
              >
            ...
            applications.map((app) => (
              <div key={app.id} className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                  ...
                  <div className="flex-1">
                    <div className="space-y-1 mb-2">
                      <p className="text-sm text-gray-400">
                        <span className="text-cyan-400 font-semibold">Vorrunde:</span> "{app.preliminary_song_title}"
                      </p>
                      <p className="text-sm text-gray-400">
                        <span className="text-electric-400 font-semibold">Finale:</span> "{app.final_song_title}"
                      </p>
                    </div>
                    <p className="text-sm text-gray-400">{new Date(app.created_at).toLocaleDateString()}</p>
                  </div>
                ...
                {app.technical_requirements && (
                  <div className="mb-4">
                    <p className="text-sm text-gray-400 mb-1">Technical Requirements:</p>
                    <p className="text-gray-300">{app.technical_requirements}</p>
                  </div>
                )}
